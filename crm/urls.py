...
urlpatterns = [
    ...
    path("receitas/<int:ano>/<int:mes>/relatorio.pdf", views.receitas_relatorio_pdf, name="receitas_relatorio_pdf"),
    ...
    path("edicao/", views.painel_edicao, name="edicao"),
    path("edicao/<int:pk>/editar/", views.edicao_evento_form, name="edicao_evento_editar"),
    path("album/", views.painel_album, name="album"),
    path("album/<int:pk>/editar/", views.album_evento_form, name="album_evento_editar"),
    ...
    path("relatorios/<str:tipo>/pdf/", views.relatorios_pdf, name="relatorios_pdf"),
