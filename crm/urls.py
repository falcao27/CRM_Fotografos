...
urlpatterns = [
    ...
    path("documentos/clientes/exportar/", views.clientes_exportar_planilha, name="clientes_exportar_planilha"),
    path("documentos/clientes/importar/", views.clientes_importar_planilha, name="clientes_importar_planilha"),
